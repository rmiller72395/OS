...
# Keys added in v4 (v5.0 safe starter toolset + HTTP allowlist)
V4_DEFAULTS: Dict[str, Any] = {
    "public_api_allowlist_domains": [],  # e.g. ["api.open-meteo.com", "api.coingecko.com"]
    "public_api_allowlist_url_prefixes": [],  # optional URL prefixes
